        ...
        <div class="content">
            ...
            <div class="history">
                ...
                <div class="item">
                    ...
                    <div class="comment">Чтобы понять насколько ты счастлив, нужно проснуться утром, закрыть глаза и представить, что ты один. Совсем один. А потом резко открыть глаза и понять, что ты уже не будешь один никогда, потому что теперь с тобой рядом и всегда будет рядом твоя вторая половинка. Мне хочется пожелать вам, чтобы вам никогда не захотелось, ни через год, ни через двадцать, закрыть глаза и насладиться тем, что вы можете быть одни. Поздравляю, Вас мои хорошие) жду не дождусь этого дня)</div>
                </div>
                <div class="item">
                    <div class="title">Яна</div>
                    <div class="comment">Чтобы понять насколько ты счастлив, нужно проснуться утром, закрыть глаза и представить, что ты один. Совсем один. А потом резко открыть глаза и понять, что ты уже не будешь один никогда, потому что теперь с тобой рядом и всегда будет рядом твоя вторая половинка. Мне хочется пожелать вам, чтобы вам никогда не захотелось, ни через год, ни через двадцать, закрыть глаза и насладиться тем, что вы можете быть одни. Поздравляю, Вас мои хорошие) жду не дождусь этого дня)</div>
